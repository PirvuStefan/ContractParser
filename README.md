...
**Note**: This application is designed for Romanian employment contracts and ID cards. Adaptation for other countries would require template modifications and potentially different OCR training.
